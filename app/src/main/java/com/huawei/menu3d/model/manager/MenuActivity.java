...
import com.huawei.menu3d.model.manager.TextActivity;
...
public class MenuActivity extends ListActivity {
    ...
    private enum Action {
        LOAD_MODEL, GITHUB, SETTINGS, UNKNOWN
    }
    ...
    private void loadModel() {
        ContentUtils.showListDialog(this, "File Provider", new String[]{"Embedded Models"}, (DialogInterface dialog, int which) -> {
            if (which == 0) {
                loadModelFromAssets();
            } else if (which == 1) {
